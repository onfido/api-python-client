...
class DefaultApi(object):
    ...
    def list_applicants(self, **kwargs):
        ...
        :param per_page: How many applicants to show per page (optional)
        :param callback function: The callback function
            for asynchronous request. (optional)
    ...
    def list_applicants_with_http_info(self, **kwargs):
        ...
        query_params = {'page': kwargs.pop('page', 1)}
        if kwargs.get('per_page'):
            query_params['per_page'] = kwargs.pop('per_page')
    ...
    def list_checks_with_http_info(self, applicant_id, **kwargs):
        ...
        all_params = ['applicant_id', 'callback', '_return_http_data_only',
                      '_preload_content', 'page', 'per_page']
    ...
    def list_reports_with_http_info(self, check_id, **kwargs):
        ...
        all_params = ['check_id', 'callback', '_return_http_data_only',
                      '_preload_content', 'page', 'per_page']

...
class Report(object):
    ...
    """
    def __init__(self, id=None, created_at=None, href=None, name=None, status=None, result=None, variant=None, options=None, breakdowns=None, properties=None):
        """
    ...
    def breakdowns(self):
        """
        Gets the breakdowns of this Report.
        The details of the report. This is specific to each type of report.

        :return: The breakdowns of this Report.
        :rtype: dict(str, str)
        """
    ...
    def breakdowns(self, breakdowns):
        """
        Sets the breakdowns of this Report.
        The details of the report. This is specific to each type of report.

        :param breakdowns: The breakdowns of this Report.
        :type: dict(str, str)
        """
